...
@section('content')
    ...
    <section class="hero">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero__item set-bg" data-setbg={{asset("img/hero/iphone_14.jpg")}}>
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg={{asset($item->photo)}}>
            ...
            <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix {{$cat->name}}">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg={{asset($item->photo)}}>
